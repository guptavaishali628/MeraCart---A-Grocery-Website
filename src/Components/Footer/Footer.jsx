...
const Footer = () => {
  return (
    <footer className='bg-zinc-100 py-20 mt-20'>
       <div className='flex flex-wrap gap-12 max-w-[1400px] mx-auto px-20'>
            ...
            <div className='flex-1'>
                ...
                <p className='mt-6 text-zinc-600'>
                    Questions or Feedabck?<br/>
                    We would love to hear from you!
                </p>
                <div className='flex bg-white p-1 rounded-lg mt-6 h-auto'>
                    <input type="email" name="email" id="email" placeholder='Email Address' autoComplete='off' className='h-[6vh] pl-4 flex-1 focus:outline-none'/>
